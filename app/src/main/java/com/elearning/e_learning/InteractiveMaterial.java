...
public class InteractiveMaterial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interactive_material);
        getSupportActionBar().setTitle("Interactive Material");

        linearLayoutGrade = (LinearLayout)findViewById(R.id.grade_layout);
        linearLayoutSubject = (LinearLayout)findViewById(R.id.subject_layout);
        linearLayoutLevel = (LinearLayout)findViewById(R.id.level_layout);

        spinnerCategory = (Spinner)findViewById(R.id.spinner_category);
        spinnerLevel = (Spinner)findViewById(R.id.spinner_level);
        spinnerFETsubject = (Spinner)findViewById(R.id.spinner_FETsubject);

        spinnerGrade = (Spinner)findViewById(R.id.spinner_serchvide_grade);

        button = (Button) findViewById(R.id.btnsearch);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(InteractiveMaterial.this, InteractiveResults.class);
